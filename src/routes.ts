...
import { getAdminById, getAllAdmins, removeAdmin, saveAdmin, adminSendOtp, adminVerifyOtp, editAdmin } from "./controller/AdminController";
import { createType, deleteType, getAllTypes } from "./controller/TypeController";
import { getAllUsers, removeUser, updateUser, sendOtp, verifyOtp, getUserById } from './controller/UserController';
